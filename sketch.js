...
function preload(){
  ...
  protestCrowd = loadSound('me.mp3', setLoaded);
}
...
function drawStartScreen(){
  fill(252, 120, 25);
  textSize(30);
  text('click screen to start sound', 100, 100);
}
...
function changeStrokeColor(){
  stroke(random(252, 141, 208), random(255, 158, 89), random(51, 242, 124));
}
